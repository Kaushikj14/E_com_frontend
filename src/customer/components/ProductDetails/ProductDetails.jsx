  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5  justify-center">
              {product.images.map((item, index) => (
                <div
                  key={index}
                  className="aspect-h-2 aspect-w-3  max-w-[5rem] max-h[5rem] overflow-hidden rounded-lg mt-4"
                >
                  <img
                    alt={item.alt}
                    src={item.src}
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-ind">
                    3870 Reviews
                  </p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              {/* Ratings Section (Now properly aligned) */}
              <Grid item xs={5}>
                <h1 className="text-xl font-semibold pb-2">Product Ratings</h1>
                <div className="flex items-center space-x-3">
                  <Rating value={4.6} precision={0.5} readOnly />
                  <p className="opacity-60">545890 Ratings</p>
                </div>
        ...
        {/* {Similar Products} */}
        <section className="pt-10">
          <h1 className="text-xl font-semibold mb-5">Similar Products</h1>
